if [ "$1" = "mscoco" ]; then
  ...
  OUTPUT_ROOT=/nas-ssd/adyasha/models/minDALLEpr/mscoco2014
elif [ "$1" = "pororo" ]; then
  echo "Training on Pororo"
  DATA_DIR=/nas-ssd/adyasha/datasets/pororo_png
  OUTPUT_ROOT=/nas-ssd/adyasha/models/minDALLEpr/pororo
  # 1e-4 learning rate?
elif [ "$1" = "flintstones" ]; then
  echo "Training on Flintstones"
  DATA_DIR=/nas-ssd/adyasha/datasets/flintstones
  OUTPUT_ROOT=/nas-ssd/adyasha/models/minDALLEpr/flintstones
elif [ "$1" = "mpii" ]; then
  ...
  OUTPUT_ROOT=/nas-ssd/adyasha/models/minDALLEpr/didemo
fi
